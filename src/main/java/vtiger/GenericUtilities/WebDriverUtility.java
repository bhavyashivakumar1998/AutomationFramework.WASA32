...
public class WebDriverUtility {
	...
	/**
	 * this methopd will double click on anywhere on the web page
	 * @param driver
	 */
	 ...
	 * @param dstElement
	 */
	public void dragAbdDropAction(WebDriver driver, WebElement srcElement, WebElement dstElement)
	{
		Actions act = new Actions(driver);
	 ...
	 */
	 ...
	 /**
	  * this method will handle the frame based on name or id
	  * @param driver
	  * @param nameOrId
	  */
	 ...
	 /** 
	  * this method will handle the frame based on element
	  * @param driver
	  * @param element
	  */
	...
	/**
	 * this method will take screen shot and save it in required folder
	 * @param driver
