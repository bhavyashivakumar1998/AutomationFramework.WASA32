...
public class Scenario2 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("accountname")).sendKeys("bhavyaabhi");
		
		//step 6: select "chemicals" in the industry drop down and save
		...
		drpindustry.selectByVisibleText("Chemicals");
		...
		if(organizationHeader.contains("bhavyaabhi"))
		{
